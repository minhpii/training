            ...
            <div class="container my-3">
              ...
              <div id="divSelect">
                @if (old('courses'))
                  ...
                  @endforeach
                @else
                  <div class="form-select row mb-3" id="div-0">
                    <div class="col-md-5">
                      {!! Form::select('courses[]', $courses->pluck('name', 'id')->toArray(), old('courses.0'), [
                      'class' => 'form-control',
                      'placeholder' => '--- Choose course ---',
                      ]) !!}
                      @error('courses.0')
                    ...
                    <div class="col-md-5">
                      {!! Form::text('scores[]', old('scores.0'), ['class' => 'form-control', 'placeholder' => 'Enter score']) !!}
                      @error('scores.0')
                      <div class="error text-danger">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="col-md-2 d-flex align-items-center">
                      <button type="button" class="btn btn-danger remove-button" data-id="0">-</button>
                    </div>
                  </div>
                @endif
              </div>
